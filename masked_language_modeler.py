...
# This script can be used to either pre-train or finetune encoder-only models like BERT, RoBERTa, etc.
# on masked language modeling objective. 
...
def parse_args():
    parser=argparse.ArgumentParser(description="Run masked language modeling")
...
def main():
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers("masked_language_modeler", experiment_config)
